    ...
    <div className="wrapper">
      <div className="current-sponsors">
        <div className="sponsors-container">
          ...
          <img
            alt="img"
            src="https://drive.google.com/uc?export=view&id=128UU4QrdniNQj2LCVkf-MomRRR1udwkU"
          />
          <div className="separator-1">
            <div className="line_1" />
          ...
          <a href="https://xp-pen.co.in/" target="_blank" rel="noreferrer">
            <img
              alt="img"
              src={process.env.REACT_APP_AWS_S3_URI + "/XPpenco-title.png"}
            />
          </a>
          <div className="separator-1">
            <div className="line_1" />
          ...
          <a href="https://www.lapcare.com/" target="_blank" rel="noreferrer">
            <img
              alt="img"
              src="https://drive.google.com/uc?export=view&id=1ftavQQIClarxTN6gfxFKipEt9Bh_JNxy"
            />
          </a>
          <div className="separator-1">
            <div className="line_1" />
          ...
          <a href="https://www.tickertape.in/" target="_blank" rel="noreferrer">
            <img
              alt="img"
              src="https://drive.google.com/uc?export=view&id=1nLK6rWZGLfCfdb7Y2FMdR7lI7W6-FT0-"
            />
          </a>
          <div className="separator-1">
            <div className="line_1" />
          ...
          <a
            href="https://indiafilmproject.co/"
            target="_blank"
            rel="noreferrer"
          >
            <img
              alt="img"
              src="https://drive.google.com/uc?export=view&id=1fqzXH6KtY_kM8KrSTYAin0zXOhnZis0x"
            />
          </a>
